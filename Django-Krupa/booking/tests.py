...
class EventTest(unittest.TestCase):
    def setUp(self):
        ...
        self.event1 = Event.objects.create(title='test title', location='test venue',
        ...
        self.event2 = Event.objects.create(title='test title', location='test venue',
